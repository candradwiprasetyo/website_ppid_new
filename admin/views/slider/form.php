                                ...
                                <div class="box-body">
                                    <div class="col-md-9">
                                        ...
                                        <div class="form-group">
                                            <label>Name</label>
                                            <input required type="text" name="i_name" class="form-control" placeholder="" value="<?= $row->slider_name ?>" title=""/>
                                        </div>
                                            <div class="form-group">
										...
										?>
                                        <br />
                                        <img src="../../assets/images/slider/<?= $row->slider_img ?>" style="width:100%;"/>
                                        <?php
										}
										?>
